...
//訂購回程票的介面
public class BookView_1 extends JFrame {
	...
	public static void main(String[] args) {
		BookView_1 frame = new BookView_1();
...
//		contentPane.add(label_15);
		...
		enterButton.setBounds(800, 650, 80, 19);
	...
	public void addSearchingButtonListener_1(ActionListener listener) {
		searchingButton.addActionListener(listener);
	}
	
	//button for next step
	public void addBookingButtonListener_1(ActionListener listener) {
