...
//			for (int j=0; j<t.getNumOfStopTimes(i); j++) {
//
//				String TrainNo = t.get(i, "GeneralTimetable", "GeneralTrainInfo", "TrainNo");
//				String StationID = t.get(i, j, "GeneralTimetable", "StopTimes", "StationID");
//				String newFileName = TrainNo+"-"+StationID+"-Seat.json";
//				System.out.println(i + " " + j + " " +newFileName);
//				try {
//					FileWriter writer = new FileWriter(System.getProperty("user.dir")+"/src/backend/file/Seat/"+newFileName);
//					writer.write(s.toString());
//					writer.close();
//				}catch(Exception e) {
//					System.out.print(e.getMessage());
